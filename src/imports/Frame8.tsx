            ...
            {hearingRanges.map((item) => {
              ...
              return (
                <div key={item.key} className="relative h-full">
                  <div
                    className="absolute left-1/2 -translate-x-1/2 w-3 rounded-full border border-white/40"
                    style={{
                      top: `${top}%`,
                      height: `${height}%`,
                      background:
                  ...
                  <div
                    className="absolute whitespace-nowrap rounded-full border border-white/20 bg-black/20 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-white/90"
                    style={{
                      left: "calc(50% - 8px)",
                      top: `${(top + bottom) / 2}%`,
